	...
	<div id="header">
		...
		<div class="container">
			...
			<div class="twelve columns">
				...
				<div id="navigation">
				  <ul>
					<li><a id="current" href="newbuy.php">Buy List</a></li>
					<li><a href="newsell.php">Sale List</a></li>
				  </ul>
				</div>			
	...
	<div id="main">
		...
		<div class="container">
			<div class="sixteen columns">
				<form action="buy.php" method="post" class="basic-grey">
				    <h1>I Want To Buy!</h1>
...
for($i=0;$i<4;$i++){
	$sql[$i] = "SELECT * FROM buy where pid % 4 = ".$id_list[$i]."";#." limit ".$start.",".$end;
#	echo $sql[$i];
	$result[$i] = $conn->query($sql[$i]);
	$len[$i] = $result[$i]->num_rows;
	$sql1[$i] = "SELECT * FROM buy where pid %4 = ".$id_list[$i]." limit ".$start.",6";
